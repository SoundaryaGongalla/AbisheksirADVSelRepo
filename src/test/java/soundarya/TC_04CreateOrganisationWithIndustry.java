...
public class TC_04CreateOrganisationWithIndustry extends BaseClass {
	@Test
...
JavaFileutility jutil=new JavaFileutility();
	String ORGNAME=eutil.fetchSingledata("testCases", 10, 3)+jutil.random();
System.out.println(ORGNAME);
String INDUSTRYTYPE=eutil.fetchSingledata("testCases", 10, 4);
